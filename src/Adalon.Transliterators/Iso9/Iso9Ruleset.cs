    ...
    internal static class Iso9Ruleset
    {
...
#else
        private static Dictionary<char, FrugalLocalList<Iso9Rule>> _rules;
        private static readonly object SyncLock = new object();
        private static Dictionary<char, FrugalLocalList<Iso9Rule>> GetRules()
        {
            if (_rules != null) return _rules;
            lock (SyncLock)
            {
                return _rules ?? (_rules = BuildRules());
            }
        }
#endif
        ...
        private static Dictionary<char, FrugalLocalList<Iso9Rule>> BuildRules()
        {
            ...
            var regular = new Char3[]
            {
                ...
                "Ч", "Č", "Ӌ", "C̣", "Ӵ", "C̈", "Ҹ", "Ĉ", "Ч̀", "C̀", "Ҽ", "C̆", "Ҿ", "C̨̆", "Ш", "Š", "Щ", "Ŝ", "Ъ", "ʺ",
                ...
                "і̄", "ǐ", "ј", "ǰ", "ј̵", "j́", "к", "k", "ќ", "ḱ", "ӄ", "ḳ", "ҝ", "k̂", "ҡ", "ǩ", "ҟ", "k̄", "к̨", "k̀",
                "ԛ", "q", "л", "l", "љ", "l̂", "м", "m", "н", "n", "њ", "n̂", "ӊ", "ṇ", "ҥ", "ṅ", "ԋ", "ǹ", "ԣ", "ń",
                "ӈ", "ň", "н̄", "n̄", "о", "o", "ӧ", "ö", "ө", "ô", "ӫ", "ő", "о̄̈", "ọ̈", "ҩ", "ò", "о́", "ó", "о̄", "ō",
                "œ", "œ", "п", "p", "ҧ", "ṕ", "ԥ", "p̀", "р", "r", "с", "s", "с̀", "s̀", "т", "t", "ћ", "ć", "ԏ", "t̀",
                "т̌", "ť", "у", "u", "ӱ", "ü", "ӯ", "ū", "ў", "ŭ", "ӳ", "ű", "у́", "ú", "ү", "ù", "ұ", "u̇", "ԝ", "w",
                "ф", "f", "х", "h", "ц", "c", "ҵ", "c̄", "џ", "d̂", "ч", "č", "ӌ", "c̣", "ӵ", "c̈", "ҹ", "ĉ", "ч̀", "c̀",
            ...
            {
                "Җ", "Ž̦", "Ž̧", "Қ", "K̦", "Ķ", "Ԡ", "L̦", "Ļ", "Ң", "N̦", "Ņ", "Ҫ", "Ș", "Ş", "Ҭ", "Ț", "Ţ", "Ҳ", "H̦",
                "Ḩ", "Ҷ", "C̦", "Ç", "җ", "ž̦", "ž̧", "қ", "k̦", "ķ", "ԡ", "l̦", "ļ", "ң", "n̦", "ņ", "ҫ", "ș", "ş", "ҭ",
                "ț", "ţ", "ҳ", "h̦", "ḩ", "ҷ", "c̦", "ç"
            };
            ...
            {
                var rule = new Iso9Rule(withUmlautAndMacron[i], withUmlautAndMacron[i + 1], withUmlautAndMacron[i + 2], false, true);
                if (!result.ContainsKey(rule.From.C0)) result[rule.From.C0] = new FrugalLocalList<Iso9Rule>();
                var lst = result[rule.From.C0];
                lst.Add(rule);
                result[rule.From.C0] = lst;
